    ...
    <div class="col-lg-12">
      <div class="card-style settings-card-2 mb-30">
        <form id="formulario" autocomplete="off" class="row">
          <div class="col-md-12">
            <?= renderInput('DESCRIPCION DEL ENTE:', 'ente', 'text', '', true); ?>
          </div>
          <div class="col-md-12">
...
<script>
  ...
  enteRegistrar.classList.add('active')

  formulario.addEventListener('submit', (e) => {
    e.preventDefault()
    Swal.fire({
      title: '¿ESTA SEGURO?',
      text: 'EL ENTE SERA REGISTRADO',
      icon: 'warning',
      ...
      if (result.isConfirmed) {
        ajaxFormularioPOST('modulos/empresas/entesRegistrar.php')
      }
    })
  })
</script>